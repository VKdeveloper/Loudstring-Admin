...
public class AccountSetupActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            LinearLayout login_layout = (LinearLayout) rootView.findViewById(R.id.login_layout);
            LinearLayout reg_layout = (LinearLayout) rootView.findViewById(R.id.register_layout);
            LinearLayout pg_footer = (LinearLayout) rootView.findViewById(R.id.pg_footer);
            final Toolbar toolbar = (Toolbar) getActivity().findViewById(R.id.toolbar);
            if(getArguments().getInt(ARG_SECTION_NUMBER) == 1)
            {
                textView.setText("Login");
                login_layout.setVisibility(View.VISIBLE);
                pg_footer.setVisibility(View.VISIBLE);
...
//                });
            ...
            else if(getArguments().getInt(ARG_SECTION_NUMBER) == 2)
            {
                ...
                pg_footer.setVisibility(View.GONE);
//                getActivity().runOnUiThread(new Runnable() {
//                    public void run() {
